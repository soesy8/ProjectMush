...
namespace Mush.Lobby.Editor
{
    ...
    {
        private const string ScenePath = "Assets/Mush/Scenes/MushLobby.unity";
        private const string GeneratedFolder = "Assets/Mush/Lobby/Generated";
        private const string AssetPath = GeneratedFolder + "/MushLobby_RuntimeContentAssets.asset";
        private const string MaterialFolder = "Assets/Mush/Lobby/Materials";
        ...
        {
            if (!AssetDatabase.IsValidFolder("Assets/Mush/Lobby"))
                AssetDatabase.CreateFolder("Assets", "MushLobby");
            if (!AssetDatabase.IsValidFolder(path))
                AssetDatabase.CreateFolder("Assets/Mush/Lobby", "Generated");
        }
