...
namespace Mush.Lobby.Editor
{
    ...
    public static class MushLowPolyLobbyDogInstaller
    {
        ...
        private const string HuskyPath = "Assets/Mush/Lobby/Dogs/Models/Mush_LowPoly_Husky.fbx";
        private const string MalamutePath = "Assets/Mush/Lobby/Dogs/Models/Mush_LowPoly_Malamute.fbx";
